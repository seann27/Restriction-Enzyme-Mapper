...
### This module tests the GenBank parsing script and prints debugging information to the console ###
...
for gene in gb:
	...
	print("gi - "+organism.gi+", geneAcc: "+geneAcc+", prod: "+gene.product+", name: "+gene.name+" strand: "+str(gene.strand)+", start: "+str(gene.start)+", stop: "+str(gene.stop))
